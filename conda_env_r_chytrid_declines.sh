...
conda create -n r_chytrid_declines -c conda-forge r-base r-dplyr r-tidyr r-tibble r-reshape2 r-ggplot2 r-ggpubr r-ape r-geiger r-phytools r-mcmcglmm r-brms r-bh r-sf r-rnaturalearth r-rnaturalearthdata -y
